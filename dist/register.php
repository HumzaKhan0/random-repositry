                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" name="conpass" id="inputConfirmPassword" type="password" placeholder="Confirm password" />
                                                    </div>
                                                </div>
                                            </div>
...
$sql = "SELECT * FROM reg WHERE email='$email'" ;
       ...
       $result = mysqli_query($con,$sql) ;
        ...
        $mail_check = mysqli_num_rows( $result ) > 0;
if (!$mail_check && $password == $conpass) {
...
//header('location: login.php');
    ...
    {
   echo ("<p class='text-danger'>There is already a user with that email!</p>");
       }
                   else if($mail_check)
    {
   echo ("<p class='text-danger'>Password and confirm password do not match kindly recheck the passwords</p>") ;
       }
} ?>